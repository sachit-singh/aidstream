    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body clearfix text-center">
                ...
                <a href="{{ route('not-my-organization') }}" class="btn btn-primary">No, this is not my organisation. Contact Support.</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade preventClose" id="contact-admin-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body clearfix text-center">
                <p>Organization: <span class="admin-name"></span></p>
                <p>
                    For a new user account, please contact the admin.
                </p>
                <a href="{{ route('need-new-user') }}" class="btn btn-primary contact-admin">Contact Administrator</a>
            </div>
        </div>
    </div>
</div>
